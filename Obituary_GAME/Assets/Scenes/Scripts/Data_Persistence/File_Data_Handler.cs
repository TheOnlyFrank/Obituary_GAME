...
public class File_Data_Handler
{
    ...
    public File_Data_Handler(string dataDirPath, string dataFileName, bool useEncryption) 
    {
    ...
    public Game_Data Load(string profileId, bool allowRestoreFromBackup = true) 
    {
        ...
        if (File.Exists(fullPath)) 
        {
            try 
            {
                ...
                loadedData = JsonUtility.FromJson<Game_Data>(dataToLoad);
            }
            catch (Exception e) 
            {
    ...
    public void Save(Game_Data data, string profileId) 
    {
        // base case - if the profileId is null, return right away
        if (profileId == null) 
        {
        ...
        try 
        {
            ...
            Game_Data verifiedGameData = Load(profileId);
    ...
    public Dictionary<string, Game_Data> LoadAllProfiles() 
    {
        Dictionary<string, Game_Data> profileDictionary = new Dictionary<string, Game_Data>();
        ...
        foreach (DirectoryInfo dirInfo in dirInfos) 
        {
            ...
            Game_Data profileData = Load(profileId);
    ...
    public string GetMostRecentlyUpdatedProfileId() 
    {
        ...
        Dictionary<string, Game_Data> profilesGameData = LoadAllProfiles();
        foreach (KeyValuePair<string, Game_Data> pair in profilesGameData) 
        {
            string profileId = pair.Key;
            Game_Data gameData = pair.Value;
